...
const RiverMilageRequest = () => {
    ...
    useEffect(() => {
        getRiverMilageRequest();
    })

    
    function getRiverMilageRequest() {

        var url = "http://biwta-db.000webhostapp.com/admin/get_river_milage_request.php";
...
const ActionComponent = (props) => {
    ...
    function editStatus() {
        ...
        axios.post('http://biwta-db.000webhostapp.com/admin/update_river_milage_request.php', fd)
        .then(res=> {
                    ...
                    <div style={{overflowY: "scroll", maxHeight: "65%"}}>
                        ...
                        <FormControl fullWidth>
                            <TextField
                                className={classes.input}
                                size="small" 
                                placeholder="River Milage Year"
                                label="River Milage Year"
                                value={editData.riverMilageYear}
                                disabled
                            />
                        </FormControl>
                        <div className={classes.spacerSmall} />
                        ...
                        <FormControl fullWidth>
                            <TextField
                                className={classes.input}
                                size="small" 
                                placeholder="River Milage Quantity"
                                label="River Milage Quantity"
                                value={editData.riverMilageQty}
                                disabled
                            />
                        </FormControl>
                        <div className={classes.spacerSmall} />
            ...
            <div>
                <IconButton onClick={()=>{
                    setEditData({
                        ...
                        riverMilageYear: props.value.riverMilageYear,
                        riverMilageQty: props.value.riverMilageQty,
